...
public class AdminTest {
    ...
    public void testCreateCustomer() {
        admin.createCustomer(1001, "password", "accountType", "nationality", 123456789, "name", "phone", "dateOfBirth", "address");
    ...
    public void testUpdateCustomer() {
        ...
        admin.updateCustomer(1001, "newPassword", "newAccountType", "newNationality", 987654321, "newName", "newPhone", "newDateOfBirth", "newAddress");
        ...
        admin.updateCustomer(1000, "new", "Customer", "new", 100, "newC", "101010", "admin", "newAddress");
        assertEquals(1000, admin.getID());
    }
